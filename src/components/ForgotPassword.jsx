...
export default function ForgotPassword() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await authService.ForgotPassword(email);  // Ensure correct function call
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/foodatreset.jpg')" }} // Fixed background image path
    >
